...
namespace Fase3.src.adts
{
    public class SimpleLinkedList<T>
    {
        ...
        public bool GenerateReport()
        {
            ...
            // Save it to a file
            File.WriteAllText("../../AutoGest_Pro/Fase3/Reportes/ListadoUsuarios.dot", result);

            ProcessStartInfo startInfo = new ProcessStartInfo("dot");

            startInfo.Arguments = $"-Tpng ../../AutoGest_Pro/Fase3/Reportes/ListadoUsuarios.dot -o ../../AutoGest_Pro/Fase3/Reportes/ListadoUsuarios.png";
